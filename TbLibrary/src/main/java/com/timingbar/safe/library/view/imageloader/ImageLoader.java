...
public final class ImageLoader {
    ...
    @Inject
    public ImageLoader(IBaseImageLoaderStrategy strategy) {
        setImageLoaderStrategy (strategy);
    }

    /**
     * 设置图片加载中策略模式接口的对象
     *
     * @param strategy 策略模式接口的对象
     */
    public void setImageLoaderStrategy(IBaseImageLoaderStrategy strategy) {
