...
public class NewsItem implements Serializable {
    ...
    private ArrayList<MediaStore.Video> video;
    ...
    private String source = "阿克苏京东方卡加速度卡加速度回复可见阿萨德航空飞机啊是款到即发会卡死监督法和卡加速度返回卡加速度回复可见阿萨德附近！！！！！";
    ...
    public NewsItem(String title, String date, int type) {
        this.title = title;
        this.date = date;
        this.type = type;
    }
    ...
    public ArrayList<String> getImgs() {
        if (images == null || images.size () == 0) {
            ...
            images.add ("http://pic2.16pic.com/00/54/72/16pic_5472673_b.jpg");
        }
        return images;
    }
    ...
    public void setVideo(ArrayList<MediaStore.Video> video) {
        this.video = video;
    }
}